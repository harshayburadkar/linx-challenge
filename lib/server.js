...
var targetsHandler = require('./routes/targets')
var targetHandler = require('./routes/target')
var routeHandler = require('./routes/route')
...
router.set('/targets', targetsHandler)
router.set('/target/:id', targetHandler)
